...
Прикреплять: эталон Темура в шатре #S4a + карта Темура #C4
...
- **Три панели решают сцену:** S58c (взгляд), S61c (осознание), S64b (улыбка)

## ПОЧЕМУ ПАНЕЛИ ЗДЕСЬ ТАК ПОХОЖИ ДРУГ НА ДРУГА

Это не ошибка и не лень. Сцена построена на том, что **ничего не меняется**.
Если в S57b, S60a, S62a и S64a Темур будет сидеть чуть иначе — власть, которая
...
pose`, и поэтому все панели с Темуром генерируются с S58c как референсом.
...
- [ ] S58a → S58b → 58c: меняются ТОЛЬКО веки, голова не двигается
- [ ] S64a → 64b: меняется ТОЛЬКО один уголок рта
- [ ] Ни одного крестоносца, красного креста, трона, изразца
- [ ] Шохрух в той же одежде, что весь фильм
- [ ] Клин дневного света из входа виден в S54a, S54b, S55a, S59a, S59b
